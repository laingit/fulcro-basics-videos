...
(def table [{:id 1 :sort 1 :lv 1 :n "a"}
            {:id 2 :sort 2 :lv 2 :n "b"}
            {:id 3 :sort 3 :lv 3 :n "c"}
            {:id 4 :sort 4 :lv 3 :n "d"}
            {:id 5 :sort 5 :lv 1 :n "e"}
            {:id 6 :sort 6 :lv 2 :n "f"}
            {:id 7 :sort 7 :lv 3 :n "g"}])
